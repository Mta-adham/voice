"""
Natural language error message generation for voice agent.

This module provides user-friendly, conversational error messages that can be
spoken naturally by the voice agent. It maps technical errors to friendly
explanations and suggests alternatives when possible.
"""
